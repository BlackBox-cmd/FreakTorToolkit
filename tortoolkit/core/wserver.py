...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://telegra.ph/file/a75f38843192f75209a94.jpg" type="image/jpg">
    <script
...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://telegra.ph/file/a75f38843192f75209a94.jpg"
          alt="logo"
        />
        <a href="https://t.me/FreakCloud"> 
          <h2 class="name">FreakTorToolkitX</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/BlackBox-cmd/FreakTorToolkitX"><i class="fab fa-github"></i></a>
        <a href="https://t.me/FreakCloud"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
async def homepage(request):
    return web.Response(
        text='<h1>🤗TorToolkitX webserver is Up and Running successfully🟢</h1>\n<h2>⚡See TorToolkitX on <a href="https://github.com/BlackBox-cmd/FreakTorToolkitX">@GitHub</a></h2>\n<h2>🥲Join FreakCloud <a href="https://t.me/https://t.me/FreakCloud">TG channel</a></h2>',
